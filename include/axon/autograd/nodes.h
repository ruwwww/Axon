...
public:
    MatMulNode(Tensor a, Tensor b, Tensor output)
        : output_(std::move(output)), inputs_{std::move(a), std::move(b)} {}
...
public:
    ReLUNode(Tensor x, Tensor output)
        : output_(std::move(output)), inputs_{std::move(x)} {}
...
public:
    MulScalarNode(Tensor x, Tensor output, float scalar)
        : output_(std::move(output)), scalar_(scalar), inputs_{std::move(x)} {}
...
public:
    TransposeNode(Tensor x, Tensor output, int64_t dim1, int64_t dim2)
        : output_(std::move(output)), dim1_(dim1), dim2_(dim2), inputs_{std::move(x)} {}
...
public:
    MeanNode(Tensor x, Tensor output, std::vector<int64_t> dims, bool keepdim)
        : output_(std::move(output)), dims_(std::move(dims)), keepdim_(keepdim), inputs_{std::move(x)} {}
...
public:
    MSELossNode(Tensor pred, Tensor target, Tensor output)
        : output_(std::move(output)), inputs_{std::move(pred), std::move(target)} {}
